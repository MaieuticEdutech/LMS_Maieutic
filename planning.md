...
| 11 | Queues, Mail & Notifications | 🟡 **8 of 10 emails; both admin screens done** | — | PR #6 built the infrastructure. Completed 2026-08-13 once Phases 8/9 shipped their triggers: `AssessmentResult`, `CourseCompleted`, the email log viewer and the queue-health panel with retry. Only `PurchaseConfirmation` and `PaymentFailed` remain — they need Phase 12's verified payment. 45 tests |

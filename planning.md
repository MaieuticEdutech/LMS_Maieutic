...
| Quality gates | Pint clean · Larastan **level 8**, 0 errors · Pest **1072/1072**, 2,252 assertions, **zero warnings** — measured on `phase/11-mail-and-queue-health` rebased on `main` (`898b977`, Phase 10 included), so the figure includes every track's work together |

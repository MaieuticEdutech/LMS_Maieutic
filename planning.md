...
| Quality gates | Pint clean · Larastan **level 8**, 0 errors · Pest **1061/1061**, 2,226 assertions, **zero warnings** — measured on `phase/11-mail-and-queue-health` branched from `main` (`435f9b5`), so the figure includes every track's work together |

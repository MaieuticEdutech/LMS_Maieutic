            ...
            @foreach ($certificates as $certificate)
                <div class="overflow-hidden rounded-card border border-neutral-200 bg-white"
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4 px-6 py-[18px]">
                        ...
                        {{-- View opens the DOCUMENT — the designed sheet with
                             the QR code on it — not the public verification
                             page, which answers a stranger's question and is
                             linked from the document itself.

                             Download returns a real PDF file. It used to open
                             the document and call window.print(), which left
                             the student to fix the print destination and untick
                             "Headers and footers" before they got anything
                             usable. See CertificateDownloadController. --}}

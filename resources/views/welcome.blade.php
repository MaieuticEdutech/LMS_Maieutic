        ...
        <x-card class="mt-8" title="Environment" description="Verified at Phase 1 installation.">
            <dl class="grid grid-cols-1 gap-x-6 gap-y-3 text-sm sm:grid-cols-2">
                <div class="flex justify-between gap-4 sm:block">
                    ...
                    <dd class="font-medium text-zinc-900">{{ app()->version() }}</dd>
                </div>
                <div class="flex justify-between gap-4 sm:block">
                    <dt class="text-zinc-500">PHP</dt>
                    <dd class="font-medium text-zinc-900">{{ PHP_VERSION }}</dd>
                </div>
                <div class="flex justify-between gap-4 sm:block">
                    <dt class="text-zinc-500">Database</dt>
                    <dd class="font-medium text-zinc-900">{{ config('database.default') }}</dd>
                </div>
                <div class="flex justify-between gap-4 sm:block">
                    <dt class="text-zinc-500">Environment</dt>
                    <dd class="font-medium text-zinc-900">{{ app()->environment() }}</dd>
                </div>
            </dl>
